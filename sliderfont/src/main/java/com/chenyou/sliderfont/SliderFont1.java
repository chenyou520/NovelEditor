 ...
 * 用于设置字体大小
 */
public class SliderFont1 extends View {
    ...
    public SliderFont1(Context context) {
        this(context, null);
    }

    public SliderFont1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SliderFont1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        mThumb = context.getResources().getDrawable(R.mipmap.ic_thumb);//移动图标
    ...
    protected void onDraw(Canvas canvas) {
        progressPaint.setColor(context.getResources().getColor(R.color.font_line));
